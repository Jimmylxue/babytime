  ...
  return (
    <View className="login-page">
      <View className="login-content">
        ...
        <View className={`login-btn ${!agreed ? 'login-btn-disabled' : ''}`} onClick={handleLogin}>
        ...
        <View className="agreement">
          ...
          <Text className="agreement-link" onClick={navigateToAgreement}>《用户协议》</Text>
          <Text className="agreement-text">和</Text>
          <Text className="agreement-link" onClick={navigateToPrivacy}>《隐私政策》</Text>
        </View>
      </View>
    </View>
  );
