	...
	return (
		<View className="privacy-page">
			...
			<View className="privacy-body">
				...
				<Text className="section-text">
					1.
					微信授权信息：当您使用微信登录时，我们会获取您的微信昵称、头像等公开信息，用于创建和管理您的账号。
				</Text>
				<Text className="section-text">
					2.
					您主动填写的信息：包括宝宝的昵称、出生日期、性别等基本信息，用于提供个性化服务。
				</Text>
				<Text className="section-text">
					3.
					您记录的内容：包括喂养记录、睡眠记录、尿布记录、身高等成长数据、照片等，这些是本应用核心功能所需的必要数据。
				</Text>
				<Text className="section-text">
					4.
					设备信息：我们可能会收集设备型号、操作系统版本等基本设备信息，用于优化应用体验和问题排查。
				</Text>

				<Text className="section-title">二、我们如何使用信息</Text>
				<Text className="section-text">我们收集的信息将用于以下目的：</Text>
				<Text className="section-text">
					1.
					提供核心服务：存储和管理您记录的宝宝成长数据，为您提供数据统计和分析功能。
				</Text>
				<Text className="section-text">
				...
				<Text className="section-text">
					2.
					存储期限：我们会在实现服务目的所必需的期限内保留您的个人信息。当您注销账号后，我们将在合理期限内删除您的个人信息。
				</Text>
				<Text className="section-text">
					3.
					安全措施：我们采用业界标准的安全技术和管理措施保护您的个人信息，包括数据加密、访问控制等，防止数据遭到未经授权的访问、泄露、篡改或丢失。
				</Text>
				...
				<Text className="section-text">1. 获得您的明确同意或授权；</Text>
				<Text className="section-text">
				...
				<Text className="section-text">您对您的个人信息享有以下权利：</Text>
				<Text className="section-text">
					1. 查看和更正：您可以随时查看和更正您在本应用中的个人信息。
				</Text>
				<Text className="section-text">
					2.
					删除：您可以删除单条记录、照片和里程碑，对应的图片文件会随删除从对象存储中一并移除。如需删除全部个人信息，您可以通过注销账号实现。
				</Text>
				<Text className="section-text">
					3.
					注销账号：您可以通过「我的 → 帮助与反馈」中的“意见反馈”或“联系客服”申请注销账号，这两处均为微信内置入口。我们核实您的身份后，会在合理期限内删除您的账号及全部个人信息，注销后数据无法恢复。
				</Text>
				<Text className="section-text">
					4.
					撤回同意：您可以通过关闭相关权限或联系我们撤回对个人信息处理的同意。
				</Text>
