	...
	return (
		<View className="agreement-page">
			...
			<View className="agreement-body">
				...
				<Text className="section-text">
					本应用是一款面向家长的宝宝成长记录工具，主要提供以下功能：宝宝日常记录（喂养、睡眠、尿布等）、成长数据统计分析、宝宝相册管理、多宝宝管理等服务。
				</Text>

				<Text className="section-title">二、账号注册与使用</Text>
				<Text className="section-text">
					1.
					您通过微信授权登录本应用，即获得本应用的使用资格。您应确保微信账号的安全性，因微信账号安全问题导致的损失由您自行承担。
				</Text>
				<Text className="section-text">
					2.
					您应提供真实、准确的注册信息，并及时更新相关信息。如因信息不真实导致的问题，由您自行承担。
				</Text>
				<Text className="section-text">
				...
				<Text className="section-text">2. 侵犯他人合法权益的行为；</Text>
				<Text className="section-text">
					3. 利用技术手段干扰本应用的正常运行；
				</Text>
				<Text className="section-text">
				...
				<Text className="section-text">
					1.
					您在本应用中发布的文字、图片等内容（以下简称"用户内容"），您保留对用户内容的所有权。
				</Text>
				<Text className="section-text">
					2.
					您授予本应用为提供服务所必需的使用权，包括存储、展示、处理用户内容等。
				</Text>
				<Text className="section-text">
					3.
					您应确保用户内容不侵犯第三方合法权益，因用户内容引发的纠纷由您自行承担。
				</Text>
				...
				<Text className="section-text">
					1.
					本应用仅提供记录和参考功能，不提供任何医疗建议。如您有健康方面的疑问，请咨询专业医生。
				</Text>
				<Text className="section-text">
					2.
					因不可抗力（包括但不限于自然灾害、网络故障、政策变化等）导致的服务中断，本应用不承担责任。
				</Text>
				<Text className="section-text">
					3.
					本应用不对因用户自身原因导致的数据丢失承担责任，建议您定期备份重要数据。
				</Text>
				...
				<Text className="section-text">
					2.
					如双方就本协议内容或其执行发生争议，应友好协商解决；协商不成的，任何一方均有权向本应用运营方所在地有管辖权的人民法院提起诉讼。
				</Text>
